  ...
  function buildPalette() {
    ...
    var commands = [].concat(
      ...
      [
        ...
        { kind: 'cmd', title: 'SnackPlay (Google Play)', sub: 'HAMDAE · play.google.com', action: function () { window.open('https://play.google.com/store/apps/details?id=com.gwangy.snackplay', '_blank', 'noopener'); } },
        { kind: 'cmd', title: 'PaletteWeather (Google Play)', sub: 'HAMDAE · play.google.com', action: function () { window.open('https://play.google.com/store/apps/details?id=com.gwangy.paletteweather', '_blank', 'noopener'); } },
        { kind: 'cmd', title: 'Healing Visualizer (Google Play)', sub: 'HAMDAE · play.google.com', action: function () { window.open('https://play.google.com/store/apps/details?id=com.gwangy.healingvisualizer', '_blank', 'noopener'); } },
        ...
        { kind: 'cmd', title: '✉️ 이메일 보내기', sub: 'gwangy.yu@gmail.com', action: function () { location.href = 'mailto:gwangy.yu@gmail.com'; } },
