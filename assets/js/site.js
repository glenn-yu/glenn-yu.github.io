  ...
  function buildPalette() {
    ...
    var commands = [].concat(
      ...
      [
        ...
        { kind: 'cmd', title: '🖼️ PhotoFit (Google Play)', sub: 'play.google.com', action: function () { window.open('https://play.google.com/store/apps/details?id=com.gwangy.photofit', '_blank', 'noopener'); } },
        { kind: 'cmd', title: '🖼️ PhotoFit (App Store)', sub: 'apps.apple.com', action: function () { window.open('https://apps.apple.com/kr/app/photofit-photo-resizer/id6793479273', '_blank', 'noopener'); } },
